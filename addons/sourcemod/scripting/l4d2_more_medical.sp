...
public void OnPluginStart()   
{
	...
	l4d2_supply = CreateConVar("l4d2_more_enabled_Supply", "1", "玩家连接或退出时根据人数设置医疗物品倍数? 0=禁用, 1=启用, 2=只显示玩家连接和退出提示(指令 !mmn 设置医疗物品倍数).", FCVAR_NOTIFY);
	l4d2_medical = CreateConVar("l4d2_more_enabled_medical", "2", "设置医疗物品的倍数(设置为只显示玩家连接和退出提示时这里设置的医疗物品倍数才会生效,使用指令 !mmn 更改倍数后这里的值失效).", FCVAR_NOTIFY);
